  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="pt-24 container mx-auto px-4 pb-20 flex-grow">
        ...
        >
          <span className="section-label mb-4 block">Identity</span>
          ...
          <div className="grid md:grid-cols-[1fr_2fr] gap-12 mb-20">
            <div className="relative">
              <div className="aspect-[3/4] border border-border bg-card overflow-hidden relative card-accent-cyan">
                <div className="absolute inset-0 bg-halftone" />
                <img src="/hero-halftone.png" className="w-full h-full object-cover opacity-80" alt="Profile" />
              </div>
            </div>

            <div className="space-y-6 font-mono text-base leading-relaxed text-muted-foreground">
              <p>
              ...
              <div className="pt-4">
                <h3 className="text-foreground font-bold mb-4 flex items-center gap-2 text-sm tracking-widest uppercase">
                ...
                <div className="border-l-2 border-accent pl-4">
                  ...
                  <div className="text-sm text-muted-foreground">California State University Fullerton, Fall 2026</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <h2 className="font-sans text-4xl font-bold mb-8 border-b border-border inline-block pb-2">
              EXPERIENCE_LOG
            </h2>
            <div className="space-y-8">
              {experiences.map((exp, i) => (
                <motion.div
                  ...
                  className="relative pl-8 border-l border-dashed border-border"
                >
                  <div className="absolute -left-[5px] top-0 w-3 h-3 bg-accent" />
                  <div className="font-mono text-xs font-bold text-accent mb-1 flex items-center gap-2 tracking-widest uppercase">
                    <Calendar className="w-3 h-3" /> {exp.year}
                  </div>
                  <h3 className="font-sans text-2xl font-bold uppercase">{exp.role}</h3>
                  <div className="font-mono text-sm font-bold mb-2 flex items-center gap-2 text-muted-foreground">
