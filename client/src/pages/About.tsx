        ...
        >
          ...
          <div className="grid md:grid-cols-[1fr_2fr] gap-12 mb-20">
            <div className="relative">
              <div className="aspect-[3/4] card-sci-fi overflow-hidden relative border-none">
                ...
                <img src="/hero-halftone.png" className="w-full h-full object-cover grayscale contrast-125 border-b-2 border-accent-cyan" alt="Profile" />
              </div>
            </div>
